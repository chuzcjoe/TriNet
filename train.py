...
def parse_args():
    ...
    parser.add_argument("--alpha_reg", dest="alpha_reg", help="regression coef", nargs="+", default="2.0")
    parser.add_argument("--beta", dest="beta", help="ortho coef", nargs="+", default="0.3")
    parser.add_argument("--num_bins", dest="num_bins", help="number of bins", nargs="+", default="60")
    ...
    parser.add_argument("--cls_loss", choices=['KLDiv', 'BCE'], help="loss type for bin classification", default='BCE', type=str)
    parser.add_argument("--reg_loss", choices=['acos','value'], help='regression target', default='value', type=str)
...
def valid(model, valid_loader, softmax, num_classes):
    ...
    with torch.no_grad():
        ...
        for j, (valid_img, cls_v1, cls_v2, cls_v3, reg_v1, reg_v2, reg_v3, _) in enumerate(valid_loader):
...
def train(net, bins, alpha, beta, batch_size):
    ...
    for epoch in range(args.epochs):
        ...
        for i, (images, cls_v1, cls_v2, cls_v3, reg_v1, reg_v2, reg_v3, name) in enumerate(train_data_loader):
            step += 1
            ...
            loss, degree_error_v1, degree_error_v2, degree_error_v3 = utils.computeLoss(cls_v1, cls_v2, cls_v3, reg_v1, reg_v2, reg_v3, 
                                                                    logits, softmax, cls_criterion, reg_criterion, [bins, alpha, beta, args.cls_loss, args.reg_loss, args.ortho_loss])
